 ...
 */
public class Re15000WaterSSTKOmegaTest {

    final String position = "./tutorials/case/single/Re15000Water";
    ...
    public static void main(String[] args) throws IOException {
        Re15000WaterSSTKOmegaTest temp = new Re15000WaterSSTKOmegaTest();
        temp.ondDcac();
        temp.describle();
        temp.flowField();
