 ...
 */
public class Re10000WaterSSTKOmegaTest {

    final String position = "./tutorials/case/single/Re10000Water";
    final String caseName = "sstkomega";

    /**
     * Reynolds nubmer
     */
    final double Re = 10000.0;
    ...
    public static void main(String[] args) throws IOException {
        Re10000WaterSSTKOmegaTest temp = new Re10000WaterSSTKOmegaTest();
        temp.ondDcac();
        temp.describle();
        temp.flowField();
