...
import com.winswe.cases.single.turbulent.kepsilon.*;
 ...
 */
public class Re8000WaterKOmegaTest {

    final String position = "./tutorials/case/single/Re8000Water";
    final String caseName = "komega";

    /**
     * Reynolds nubmer
     */
    final double Re = 8000.0;
    ...
    public static void main(String[] args) throws IOException {
        Re8000WaterKOmegaTest temp = new Re8000WaterKOmegaTest();
        temp.ondDcac();
        temp.describle();
        temp.flowField();
