...
/**
 * 测试湍流+界面摩擦 测试刘楠楠数据
 * <n>1.取消中间卡门系数的设定，效果几乎没有</n>
 * <n>2.中间界面的波动大，两边的波动小，因此引入了cacWave()，引入后也没有效果</n>
 * <n>3.不引入温度的影响因素，仅考虑Wave函数</n>
 *
 * @author winsway
 */
public class TestTF4Wave {
...
//        
        ...
        double errF, errG;
//
        komegaTFOWAngeli2Wave test = new komegaTFOWAngeli2Wave(Qoil, Qwater, Radia);
...
//        
        ...
        do {
            ...
            pw.flush();
            komegaTFOWAngeli2Wave F1 = new komegaTFOWAngeli2Wave(Qoil, Qwater, Radia);
...
//            
            ...
            pw.flush();
            komegaTFOWAngeli2Wave Fx1 = new komegaTFOWAngeli2Wave(Qoil, Qwater, Radia);
...
//            
            ...
            pw.flush();
            komegaTFOWAngeli2Wave Fy1 = new komegaTFOWAngeli2Wave(Qoil, Qwater, Radia);
