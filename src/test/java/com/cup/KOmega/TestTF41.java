...
/**
 * 测试湍流+界面摩擦 测试刘楠楠数据
 * <1>1.取消中间卡门系数的设定，效果几乎没有</1>
 * <1>2.中间界面的波动大，两边的波动小，因此引入了cacWave()，引入后也没有效果</1>
 * @author winsway
 */
public class TestTF41 {
...
//        
        ...
        double errF, errG;
//
        komegaTFOWAngeli2 test = new komegaTFOWAngeli2(Qoil, Qwater, Radia);
