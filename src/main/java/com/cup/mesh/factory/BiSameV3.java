...
import static com.cup.stratifiedflow.StrtifiedFlow.main;
 ...
 * @author winsway
 */
public class BiSameV3 extends AbstractMesh {
...
//        }
    ...
    public BiSameV3(double X, double Y, double Z, int nx, int ny, int nz) {
        super(X, Y, Z, nx, ny, nz);
    }

    public BiSameV3(double X, double Y, int nx, int ny) {
        this(X, Y, 1, nx, ny, 1);
    }
    ...
    @Override
    public BiSameV3 clone() {
        BiSameV3 clone = new BiSameV3(this.LX, this.LY, this.LZ, this.NX, this.NY, this.NZ);
        clone.a = this.a;
    ...
    public Mesh fineMesh(Mesh cellf) {
        BiSameV3 clone = new BiSameV3(this.LX, this.LY, this.LZ, this.NX / 2, this.NY / 2, this.NZ);
        clone.a = this.a;
        clone.interhL = this.interhL;
        clone.radia = this.radia;
        clone.theta1 = this.theta1;
