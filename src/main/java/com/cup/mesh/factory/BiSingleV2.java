 ...
 * @author winsway
 */
public class BiSingleV2 extends AbstractMesh {
...
//            System.out.println("j = " + j + "; x1 = " + x1[j]);
    ...
    public BiSingleV2(double X, double Y, double Z, int nx, int ny, int nz) {
        super(X, Y, Z, nx, ny, nz);
    }

    public BiSingleV2(double X, double Y, int nx, int ny) {
        this(X, Y, 1, nx, ny, 1);
    }
    ...
    @Override
    public BiSingleV2 clone() {
        BiSingleV2 clone = new BiSingleV2(this.LX, this.LY, this.LZ, this.NX, this.NY, this.NZ);
        clone.a = this.a;
