 ...
 * @author winsway
 */
public class BiSameV1 extends AbstractMesh {
...
//            System.out.println("j = " + j + "; x1 = " + x1[j]);
    ...
    public BiSameV1(double X, double Y, double Z, int nx, int ny, int nz) {
        super(X, Y, Z, nx, ny, nz);
    }

    public BiSameV1(double X, double Y, int nx, int ny) {
        this(X, Y, 1, nx, ny, 1);
    }
     ...
     */
    @Override
    public BiSameV1 clone() {
        BiSameV1 clone = new BiSameV1(this.LX, this.LY, this.LZ, this.NX, this.NY, this.NZ);
        clone.a = this.a;
