 ...
 */
package com.cup.solver;

import com.cup.tur.model.komega.tf.*;
...
//  网格数
    ...
    public Laminar(String position, String Title) {
    ...
    void scheme3(Structed2D mesh) throws FileNotFoundException {
        RESULT(0);
        cacW2(
                dpdz,
                mesh, F[W],
    ...
    double cacMu(double phi, double rho) {
...
//得到源项
        ...
        F.getLog().rl = MatrixSolver.gaussSeidel(F.getNewField(), coeW, sys, 20);
        F.getLog().log("W");
    }
     ...
     * @param dpdz
     */
    void cacW2(double dpdz,
            Structed2D mesh, Field F,
            double[][][] mu, double[][][] rho,
            double[][][] Mut, SystemControl sys
    ) {
        double URF = SOR[this.W];
...
//        
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Laminar temp = new Laminar("./tutorials/case/single", "laminar");
        double[] porW = {1000, 1.00e-3, 0.6, 4186};
        temp.setFluid(porW, porW);
        ...
        temp.setBoundary(bc);
        temp.setMesh(50, 50);
        temp.application(2.2301, 0.5, 0.0243 / 2.0, 300);
        temp.scheme2();
        //        
