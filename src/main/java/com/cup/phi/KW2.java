...
public final class KW2 {
     ...
     * @param Radia
     */
    public KW2(double Qoil, double Qwater, double Radia) {
        this.Qoil = Qoil;
        this.Qwater = Qwater;
        this.Radia = Radia;
    }
     ...
     * @param Radia 管径,m
     */
    public KW2(double Qoil, double Qwater, double TOil, double TWater, double Radia) {
        this.Qoil = Qoil;
        this.Qwater = Qwater;
        this.TOil = TOil;
        this.TWater = TWater;
    ...
    void initial() {
        ...
        for (int i = 0; i < X.length; i++) {
            X[i][old] = new KW(Qoil, Qwater, TOil, TWater, BC, Radia);
            X[i][old].position = position;
            X[i][old].Title = "Xold" + i + "\\";
            X[i][old].setFluid(testO, testW);
            X[i][old].start(dpdz, hl);
            //
            X[i][now] = new KW(Qoil, Qwater, TOil, TWater, BC, Radia);
    ...
    void Newton(double dpdz, double yint, KW get) throws FileNotFoundException {
        String dirName = this.position + this.toString();
...
//        
        do {
            ...
            pw.flush();
//            
            F1 = new KW(Qoil, Qwater, Radia);
            F1.setFluid(testO, testW);
...
//           
            ...
            pw.flush();
//            
            Fx1 = new KW(Qoil, Qwater, Radia);
            Fx1.setFluid(testO, testW);
            Fx1.application(xold * 1.01, yold, 5);
//            
            Fy1 = new KW(Qoil, Qwater, Radia);
