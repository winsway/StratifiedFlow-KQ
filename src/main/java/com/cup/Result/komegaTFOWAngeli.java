 ...
 * @author 齐雪宇
 */
public final class komegaTFOWAngeli {
...
//under-relaxization
    ...
    public komegaTFOWAngeli(double Qso, double Qsw, double Radia) {
        this.Qso = Qso;
        this.Qsw = Qsw;
        this.R = Radia;
    }
...
//        
        ...
        do {
            ...
            pw.flush();
            komegaTFOWAngeli F1 = new komegaTFOWAngeli(Qoil, Qwater, Radia);
            ...
            pw.flush();
            komegaTFOWAngeli Fx1 = new komegaTFOWAngeli(Qoil, Qwater, Radia);
            Fx1.application(xold * 1.01, yold);
            System.out.println("Fy1   " + " xold =" + xold + " yold * 1.01 =" + yold * 1.01);
            pw.printf("Fy1 xold =%e\t yold * 1.01 =%e\t\n", xold, yold * 1.01);
            pw.flush();
            komegaTFOWAngeli Fy1 = new komegaTFOWAngeli(Qoil, Qwater, Radia);
