 ...
 */
public class TwoPhaseSolverForOneCase {
     ...
     * @param caseName
     */
    public TwoPhaseSolverForOneCase(String path, String caseName) {
...
//
            ...
            Logger.getLogger(TwoPhaseSolverForOneCase.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
