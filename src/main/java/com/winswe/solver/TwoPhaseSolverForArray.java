 ...
 */
public class TwoPhaseSolverForArray {
     ...
     * @param caseName
     */
    public TwoPhaseSolverForArray(String path, String caseName, Info info) {
    ...
    public void createField() {
        ...
        JSONObject geometricJson = iOobject.getJsonObject().getJSONObject("geometric");
        double diameter = geometricJson.getDoubleValue("diameter");
        Qoil = SingleFlowEquation.calculateVolumeFlowrateByAverageVelocity(info.Uso, diameter);
        Qwater = SingleFlowEquation.calculateVolumeFlowrateByAverageVelocity(info.Usw, diameter);
...
//
            ...
            Logger.getLogger(TwoPhaseSolverForArray.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
